                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>
                                <a href="${data.referralLink}" class="button" style="background-color:rgb(189, 83, 30); border-radius: 20px; color: #fff; display: inline-block; text-decoration: none; padding: 12px 30px; font-size: 16px;">
